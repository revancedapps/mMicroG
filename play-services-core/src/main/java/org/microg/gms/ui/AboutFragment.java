...
public class AboutFragment extends AbstractAboutFragment {
    ...
    protected void collectLibraries(List<AbstractAboutFragment.Library> libraries) {
        ...
        if (BuildConfig.INCLUDED_PROJECTS.toLowerCase().contains("cast")) {
        ...
        if (BuildConfig.INCLUDED_PROJECTS.toLowerCase().contains("conscrypt")) {
        ...
        if (BuildConfig.INCLUDED_PROJECTS.toLowerCase().contains("cronet")) {
        ...
        if (BuildConfig.INCLUDED_PROJECTS.toLowerCase().contains("location")) {
        ...
        if (BuildConfig.INCLUDED_PROJECTS.toLowerCase().contains("wearable")) {
